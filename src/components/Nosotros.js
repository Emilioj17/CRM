...
const Nosotros = () => {
  return (
    <div className="my-5" id="nosotros">
              ...
              <div className="row g-0 mb-5">
                ...
                <div className="col-md-10">
                  <div className="card-body">
                    <h4 className="card-title">Fabián Lopez</h4>
                    <h5 className="card-title">Descripcion breve</h5>
                    <p className="card-text text-muted">Joven con amplio espíritu de superación, metódico, comprometido y responsable en el cumplimiento de metas,
                      empático y agradecido del trabajo en equipo.
                      Busco la superación personal, profesional y ética en la cual pueda expandir mis conocimientos de tal manera que pueda
                      contribuir al logro de metas en modo de organización.</p>
                  </div>
                </div>
              </div>
              <div className="row g-0 mb-5">
